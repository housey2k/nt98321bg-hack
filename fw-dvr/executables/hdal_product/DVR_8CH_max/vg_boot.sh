...
modprobe h26xdec h26xd_max_width=3840 h26xd_max_height=2164 max_total_cam_ch=20
...
if [ "$AD_MODULE" == "techpoint" ]; then
    /mnt/mtd/module_init /mnt/mtd/cfg_DVR_8CH_max.dtb 0 1 1 1 0 &
else
	/mnt/mtd/module_init /mnt/mtd/cfg_DVR_8CH_max.dtb 0 2 1 1 0 &
fi
